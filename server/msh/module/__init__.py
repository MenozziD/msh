...
from module.net import cmd_radio, cmd_ping, cmd_esp, cmd_netscan, cmd_radio_stato, compile_arduino, upload_arduino, cmd_pcwin, wifi_ap_info, cmd_ps4, cmd_pcmac, cmd_reboot,cmd_pclinux
