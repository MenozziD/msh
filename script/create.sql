BEGIN TRANSACTION;
-- Creazione Tabelle
CREATE TABLE "TB_NET_DEVICE" ( `NET_ID` INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT UNIQUE, `NET_CODE` TEXT NOT NULL, `NET_DESC` TEXT NOT NULL, `NET_NAME` TEXT NOT NULL, `NET_TYPE` TEXT NOT NULL, `NET_STATUS` TEXT DEFAULT '', `NET_LASTUPDATE` TEXT DEFAULT (datetime('now','localtime')), `NET_IP` TEXT DEFAULT '', `NET_MAC` TEXT DEFAULT '', `NET_USER` TEXT, `NET_PSW` TEXT, `NET_MAC_INFO` TEXT DEFAULT '' );
