BEGIN TRANSACTION;
-- Creazione Tabelle
CREATE TABLE "TB_NET_DEVICE" ( `NET_ID` INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT UNIQUE, `NET_CODE` TEXT NOT NULL, `NET_DESC` TEXT, `NET_TYPE` TEXT NOT NULL, `NET_STATUS` TEXT DEFAULT '', `NET_LASTUPDATE` TEXT DEFAULT (datetime('now','localtime')), `NET_IP` TEXT DEFAULT '', `NET_MAC` TEXT DEFAULT '', `NET_USER` TEXT, `NET_PSW` TEXT, `NET_MAC_INFO` TEXT DEFAULT '' );
...
CREATE TABLE "TB_DEVICE_TYPE" ( `TYPE_CODE` TEXT NOT NULL UNIQUE, `TYPE_DESCRIPTION` TEXT DEFAULT '-', PRIMARY KEY(`TYPE_CODE`) );
...
INSERT INTO TB_RES_DECODE (RES_DEVICE_TYPE,RES_DEVICE_SUBTYPE,RES_COMMAND,RES_LANG,RES_VALUE,RES_RESULT,RES_STATE) VALUES ("NET","NET","100","IT","-1","Ping OK!","ON");
...
INSERT INTO TB_DEVICE_TYPE (TYPE_CODE,TYPE_DESCRIPTION) VALUES ("NET","Generic Device");
INSERT INTO TB_DEVICE_TYPE (TYPE_CODE,TYPE_DESCRIPTION) VALUES ("PCWIN","PC Windows");
INSERT INTO TB_DEVICE_TYPE (TYPE_CODE,TYPE_DESCRIPTION) VALUES ("AP","Access Point UNIX based SSH Compatible");
INSERT INTO TB_DEVICE_TYPE (TYPE_CODE,TYPE_DESCRIPTION) VALUES ("PS4","Sony Playstation 4");
INSERT INTO TB_DEVICE_TYPE (TYPE_CODE,TYPE_DESCRIPTION) VALUES ("XBULB","Xiaomi Yeelight Bulb");
COMMIT;
